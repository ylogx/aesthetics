...
class FisherVector(object):
    ...
    * features(self, folder, limit): Returns fisher vectors for all images in subfolders of given folder
    ...
    def __init__(self, gmm):
        """
        :param gmm: Trained gmm to be used
        :type gmm: aesthetics.fisher.Gmm
        """
        self.gmm = gmm
    ...
    def features(self, folder, limit):
        ...
        :type folder: str
        :param limit: Number of images to read from each subfolder
        :type limit: int
    ...
    def get_fisher_vectors_from_folder(self, folder, limit):
        ...
        :param folder: Folder Name
        :type folder: str
        :param limit: Number of images to read from each folder
        :type limit: int
    ...
    def fisher_vector_of_image(self, img):
        """
        :param img: Img Array generated by cv2.imread
        :type img: np.array
