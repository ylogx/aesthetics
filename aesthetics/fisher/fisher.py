...
class FisherVector(object):
    ...
    * features(self, folder, limit): Returns fisher vectors for all images in subfolders of given folder
    ...
    def fisher_vector_of_img_array(self, img):
        """
        Sections the original image into three horizontal images of same dimensions and returns a concatenated array
        of the fisher vector of the original, top, middle and segments of the image
        ...
        def section_fisher(img_section, full_fisher):
            """
            :param img_section: Section of the image for which fisher vector is desired
            :param full_fisher: Fisher vector of the original image
            :return: sec_fisher: Fisher vector of the section of the image
            """
    ...
    def fisher_vector_of_image_section(self, img):
        """
        Returns fisher vector of the section of the image
        :param np.array img: Img Array generated by cv2.imread
